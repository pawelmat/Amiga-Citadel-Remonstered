...
1. Change the IS_EXE flag in the source code from 'IS_EXE: equ 0' to 'IS_EXE: equ 1'.
2. Follow steps 1-7 from the previous section
3. Type 'wb cyt.dat'.
4. When prompted BEG> type 's', and then when prompted END> type 'end'. This will save cyt.dat in the working directory.
5. Copy cyt.dat to your folder with the WHDLoad install and other files, replacing the old cyt.dat.
6. Run the game: 'whdload citadel.slave'
